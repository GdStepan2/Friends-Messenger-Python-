...
Небольшой мессенджер “для друзей” на Python.
...
админ-приложение для создания аккаунтов (друзей)

стикеры (emoji)

ответы на сообщения (через ПКМ по сообщению)

уведомления справа снизу (Windows tray) о новых сообщениях

уведомления “пользователь онлайн” (можно выключить)

подсветка новых сообщений жёлтым до начала ввода
...
Python 3.10+ (у автора работает и на 3.14)
...
Prompt для ChatGPT (поддержка проекта)
